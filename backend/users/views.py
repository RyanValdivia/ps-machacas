...
# Crear Usuario
@api_view(['POST'])
@permission_classes([AllowAny]) ##REVISAR
...
# Listar usuarios TESTADA FUNCIONAL
@api_view(['GET'])
...
def list_users(request):
    ...
    if is_manager:
        # Iniciar queryset
        users = User.objects.all().order_by('usuCod') 
    
    else:
        # NO GERENTE: no recuperar       
...
# Vendedores disponibles para designar a una venta
@api_view(['GET'])
@permission_classes([IsAuthenticated])
