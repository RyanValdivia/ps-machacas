...
- Name: auth-roles.spec.ts >> E2E-AUTH-03: Bloqueo de rutas por nivel de acceso >> Debería mostrar "Acceso restringido" al usuario nivel 2 en /settings @acceptance
- Location: tests/auth-roles.spec.ts:24:3
