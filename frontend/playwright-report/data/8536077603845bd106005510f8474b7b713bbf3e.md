...
- Name: dashboard.spec.ts >> Navegación y Dashboard - RegistraMe >> Debería permitir navegar a las diferentes vistas usando el Sidebar @system
- Location: tests/dashboard.spec.ts:22:3
